...
// RegionIDsNoSTUNOnly returns the sorted region IDs excluding regions
// where ALL nodes are STUNOnly.
...
// HasSTUN reports whether any node in any region has STUN enabled
// (STUNPort >= 0).
